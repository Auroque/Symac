<?php
// Dê um Find Replace (CASE SENSITIVE!) em Diferenciais pelo nome do seu post type 

class Diferenciais
{
    const NAME = 'Diferenciais';
    const MENU_NAME = 'Diferenciais';
    ...
    static function register()
    {
        register_post_type(self::$post_type, array(
            'labels' => array(
                ...
                'singular_name' => _x('Diferenciais', 'post type singular name', 'SLUG'),
                'add_new' => _x('Adicionar Novo', 'image', 'SLUG'),
                'add_new_item' => __('Adicionar novo Diferenciais', 'SLUG'),
                'edit_item' => __('Editar Diferenciais', 'SLUG'),
                'new_item' => __('Novo Diferenciais', 'SLUG'),
                'view_item' => __('Ver Diferenciais', 'SLUG'),
                'search_items' => __('Search Diferenciais', 'SLUG'),
                'not_found' => __('Nenhum Diferenciais Encontrado', 'SLUG'),
                'not_found_in_trash' => __('Nenhum Diferenciais na Lixeira', 'SLUG'),
                'parent_item_colon' => ''
            ),
            'public' => true,
