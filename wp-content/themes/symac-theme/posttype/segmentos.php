<?php
// Dê um Find Replace (CASE SENSITIVE!) em Segmentos pelo nome do seu post type 

class Segmentos
{
    const NAME = 'Segmentos';
    const MENU_NAME = 'Segmentos';
    ...
    static function register()
    {
        register_post_type(self::$post_type, array(
            'labels' => array(
                ...
                'singular_name' => _x('Segmentos', 'post type singular name', 'SLUG'),
                'add_new' => _x('Adicionar Novo', 'image', 'SLUG'),
                'add_new_item' => __('Adicionar novo Segmentos', 'SLUG'),
                'edit_item' => __('Editar Segmentos', 'SLUG'),
                'new_item' => __('Novo Segmentos', 'SLUG'),
                'view_item' => __('Ver Segmentos', 'SLUG'),
                'search_items' => __('Search Segmentos', 'SLUG'),
                'not_found' => __('Nenhum Segmentos Encontrado', 'SLUG'),
                'not_found_in_trash' => __('Nenhum Segmentos na Lixeira', 'SLUG'),
                'parent_item_colon' => ''
            ),
            'public' => true,
