<?php
// Dê um Find Replace (CASE SENSITIVE!) em Segmento pelo nome do seu post type 

class Segmento
{
    const NAME = 'Segmento';
    const MENU_NAME = 'Segmento';
    ...
    static function register()
    {
        register_post_type(self::$post_type, array(
            'labels' => array(
                ...
                'singular_name' => _x('Segmento', 'post type singular name', 'SLUG'),
                'add_new' => _x('Adicionar Novo', 'image', 'SLUG'),
                'add_new_item' => __('Adicionar novo Segmento', 'SLUG'),
                'edit_item' => __('Editar Segmento', 'SLUG'),
                'new_item' => __('Novo Segmento', 'SLUG'),
                'view_item' => __('Ver Segmento', 'SLUG'),
                'search_items' => __('Search Segmento', 'SLUG'),
                'not_found' => __('Nenhum Segmento Encontrado', 'SLUG'),
                'not_found_in_trash' => __('Nenhum Segmento na Lixeira', 'SLUG'),
                'parent_item_colon' => ''
            ),
            'public' => true,
